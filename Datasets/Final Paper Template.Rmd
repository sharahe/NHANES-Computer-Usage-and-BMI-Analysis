...
data2 = read_csv("categoricalvariabletable.csv")
data2 <- data2
...
DR2TOT <- read.csv("DR2TOT_I.csv")
DR2TOT <- DR2TOT %>%
  select(SEQN, Dietary = DR2TKCAL)

PAQ <- read.csv("PAQ_I.csv")
PAQ <- PAQ %>% 
...
data = read_csv("fivenumbersummary.csv")
kable(data) %>%
...
demo = read_csv('DEMO_I.csv')
comp = read_csv('PAQ_I.csv')
...
DEMO = read_csv("DEMO_I.csv")
DR2TOT = read_csv("DR2TOT_I.csv")
BMX = read_csv("BMX_I.csv")
